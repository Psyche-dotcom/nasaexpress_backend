...
namespace PetProject.Service.Implementation
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(IAccountRepo accountRepo, ILogger<AccountService> logger, IEmailServices emailServices, IGenerateJwt generateJwt, PetProjectDbContext context)
        {
        ...
        public async Task<ResponseDto<string>> RegisterUser(SignUp signUp, string Role)
        {
            ...
            try
            {
                ...
                mapAccount.DriverLicenceExpiryDate = signUp.DriverLicenceExpiryDate;
                mapAccount.DriverLicence = signUp.DriverLicence;
                ...
                await _context.AddAsync(createwallet);
